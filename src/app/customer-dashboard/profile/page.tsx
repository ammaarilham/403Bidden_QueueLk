                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Enter official title" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  return (
                    <div key={name} className="flex flex-col gap-3">
                      ...
                      <Input
                        ...
                        className="file:bg-muted-foreground/10 file:text-muted-fobg-muted-foreground hover:file:bg-muted-foreground/20 h-11 p-2 file:mr-4 file:rounded-full file:border-0 file:px-2.5 file:py-0 file:text-sm file:font-medium"
                      />
                    </div>
                  );
                })}
